...
public:
    ...
    nazwaTymczasowegoPlikuZAdresatami(nazwaPlikuZAdresatami.insert( nazwaPlikuZAdresatami.size()-4 ,"_tymczasowo")) {
    ...
    void usunWybranaLinieWPliku(int numerUsuwanejLinii, int idUsuwanegoAdresata);
